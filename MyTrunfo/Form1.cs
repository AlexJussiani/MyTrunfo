    ...
    public partial class Form1 : Form
    {
        ...
        private void TurnCard(EPlayer player)
        {
            if (player == EPlayer.Player1)
            {
                ...
                UpdateCards(EPlayer.Player1);
            }
            if (player == EPlayer.Player2)
            {
                Player2IsVisible = !Player2IsVisible;
                UpdateCards(EPlayer.Player2);
            }
        }

        private void UpdateCards(EPlayer player)
        {
            if (player == EPlayer.Player1)
            {
                lbCarNamePlayer1.Visible = Player1IsVisible;
                lbCarBrandPlayer1.Visible = Player1IsVisible;
                lbCodePlayer1.Visible = Player1IsVisible;
                lblConsumptionPlayer1.Visible = lblConsumptionPlayer1Value.Visible = Player1IsVisible;
                lblPowerPlayer1.Visible = lblPowerPlayer1Value.Visible = Player1IsVisible;
                lblWidthPlayer1.Visible = lblWidthPlayer1Value.Visible = Player1IsVisible;
                lbldisplacementsPlayer1.Visible = lbldisplacementsPlayer1Value.Visible = Player1IsVisible;
                lblSpeedPlayer1.Visible = lblSpeedPlayer1Value.Visible = Player1IsVisible;
                ...
                picCardPlay1.Image = Player1IsVisible ? Resources.Front : Resources.Back;
            }
            if (player == EPlayer.Player2)
            {
                lbCarNamePlayer2.Visible = Player2IsVisible;
                lbCarBrandPlayer2.Visible = Player2IsVisible;
                lbCodePlayer2.Visible = Player2IsVisible;
                lblConsumptionPlayer2.Visible = lblConsumptionPlayer2Value.Visible = Player2IsVisible;
                lblPowerPlayer2.Visible = lblPowerPlayer2Value.Visible = Player2IsVisible;
                lblWidthPlayer2.Visible = lblWidthPlayer2Value.Visible = Player2IsVisible;
                lbldisplacementsPlayer2.Visible = lbldisplacementsPlayer2Value.Visible = Player2IsVisible;
                lblSpeedPlayer2.Visible = lblSpeedPlayer2Value.Visible = Player2IsVisible;
                ...
                picCardPlay2.Image = Player2IsVisible ? Resources.Front : Resources.Back;
            }
        }

        //Esse metodo verifica o vencedor
        private void Compare(ECategory eCategory)
        {
            var winner = type(eCategory);
            MessageBox.Show("Próxima Rodada!");
            if (winner == EPlayer.Player1)
            {
                Player1Cards.Add(CarPlayer1);
                Player1Cards.Add(CarPlayer2);
                Player2Cards.Remove(CarPlayer2);
            }
            if (winner == EPlayer.Player2)
            {
                Player2Cards.Add(CarPlayer2);
                Player2Cards.Add(CarPlayer1);
                Player1Cards.Remove(CarPlayer1);
            }
            if (winner == EPlayer.Tied)
            {
                TiedCards.Add(CarPlayer2);
                TiedCards.Add(CarPlayer1);
                Player1Cards.Remove(CarPlayer1);
                Player2Cards.Remove(CarPlayer2);
        ...
        private EPlayer type(ECategory eCategory)
        {
            Boolean player1 = false;
            Boolean player2 = false;
            if (eCategory == ECategory.Consumption)
            {
                player1 = (CarPlayer1.Consumption > CarPlayer2.Consumption);
                player2 = (CarPlayer1.Consumption < CarPlayer2.Consumption);
                lblConsumptionPlayer2Value.Text = CarPlayer2.Displacements.ToString();

            }
            if (eCategory == ECategory.Displacements)
            {
                player1 = (CarPlayer1.Displacements > CarPlayer2.Displacements);
                player2 = (CarPlayer1.Displacements < CarPlayer2.Displacements);
                lbldisplacementsPlayer2Value.Text = CarPlayer2.Displacements.ToString();
            }
            if (eCategory == ECategory.HorsePower)
            {
                player1 = (CarPlayer1.HorsePower > CarPlayer2.HorsePower);
                player2 = (CarPlayer1.HorsePower < CarPlayer2.HorsePower);
                lblPowerPlayer2Value.Text = CarPlayer2.HorsePower.ToString();
            }
            if (eCategory == ECategory.Length)
            {
                player1 = (CarPlayer1.Length > CarPlayer2.Length);
                player2 = (CarPlayer1.Length < CarPlayer2.Length);
                lblWidthPlayer2Value.Text = CarPlayer2.Length.ToString();
            }
            if (eCategory == ECategory.MaxSpeed)
            {
                player1 = (CarPlayer1.MaxSpeed > CarPlayer2.MaxSpeed);
                player2 = (CarPlayer1.MaxSpeed < CarPlayer2.MaxSpeed);
                lblSpeedPlayer2Value.Text = CarPlayer2.MaxSpeed.ToString();
            }
            if (eCategory == ECategory.Price)
            {
                player1 = (CarPlayer1.Price < CarPlayer2.Price);
                player2 = (CarPlayer1.Price > CarPlayer2.Price);
                lblPricePlayer2Value.Text = CarPlayer2.Price.ToString();
            }
            if (player1)
            {
        ...
        private void InitializeGame(EPlayer player)
        {
        ...
        private void TurnPlayer2()
        {
            ...
            ECategory randomCategori = (ECategory)values.GetValue(index);
            MessageBox.Show("Oponente escolheu " + EnumsToString.ToString(randomCategori));
            Compare(randomCategori);
        }
        ...
        private void PopulatePlayer(EPlayer player)
        {
            if (player == EPlayer.Player1)
            {
                CarPlayer1 = Player1Cards.FirstOrDefault();
                Player1Cards.Remove(Player1Cards.FirstOrDefault());
                picCarPlayer1.Image = CarPlayer1.Image;
                lblConsumptionPlayer1Value.Text = CarPlayer1.Consumption.ToString();
                lbCarBrandPlayer1.Text = CarPlayer1.Name;
                lblPowerPlayer1Value.Text = CarPlayer1.HorsePower.ToString();
                lblWidthPlayer1Value.Text = CarPlayer1.Length.ToString();
                lblSpeedPlayer1Value.Text = CarPlayer1.MaxSpeed.ToString();
                lbldisplacementsPlayer1Value.Text = CarPlayer1.Displacements.ToString();
                lblPricePlayer1Value.Text = CarPlayer1.Price.ToString();
            }
            else if (player == EPlayer.Player2)
            {
                CarPlayer2 = Player2Cards.FirstOrDefault();
                Player2Cards.Remove(Player2Cards.FirstOrDefault());
                picCarPlayer2.Image = CarPlayer2.Image;
                lblConsumptionPlayer2Value.Text = CarPlayer2.Consumption.ToString();
                lblPowerPlayer2Value.Text = CarPlayer2.HorsePower.ToString();
                lblWidthPlayer2Value.Text = CarPlayer2.Length.ToString();
                lblSpeedPlayer2Value.Text = CarPlayer2.MaxSpeed.ToString();
                lbldisplacementsPlayer2Value.Text = CarPlayer2.Displacements.ToString();
        ...
        private void CreateCards()
        {
            ...
            AllCards.Add(new Car() { Id = 1, Code = "C2", Name = "Alure 408", Image = Resources.Alure_408, Brand = "Peugeot", Country = ECountry.France, Consumption = 10m, HorsePower = 115, Length = 4159, MaxSpeed = 185, Displacements = 1600, Price = 83 });
            AllCards.Add(new Car() { Id = 2, Code = "A6", Name = "Amarok", Image = Resources.Amarok, Brand = "Volkswagen", Country = ECountry.Germany, Consumption = 10m, HorsePower = 180, Length = 5254, MaxSpeed = 179, Displacements = 2000, Price = 243 });
            AllCards.Add(new Car() { Id = 3, Code = "A2", Name = "Astra", Image = Resources.Astra, Brand = "Chevrolet", Country = ECountry.USA, Consumption = 10m, HorsePower = 128, Length = 4199, MaxSpeed = 201, Displacements = 2000, Price = 29 });
            AllCards.Add(new Car() { Id = 4, Code = "C1", Name = "Bandeirantes", Image = Resources.Bandeirantes, Brand = "Toyota", Country = ECountry.Japan, Consumption = 10m, HorsePower = 96, Length = 5300, MaxSpeed = 125, Displacements = 3661, Price = 40 });
        }
        ...
        private void btn_start_Click(object sender, EventArgs e)
        {
            ...
            TurnCard(EPlayer.Player1);
            InitializeGame(EPlayer.Player1);            
        }
