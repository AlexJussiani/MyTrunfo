    ...
    public partial class Form1 : Form
    {
        ...
        private void Compare(ECategory eCategory)
        {
            ...
            if (winner == EPlayer.Tied)
            {
                ...
                winner = ObservationPlayer(LastPlayer);
        ...
        //Esse metodo é chamado quando da empate para verificar quem é o próximo Jogador
        private EPlayer ObservationPlayer(EPlayer player)
        {
            return player == EPlayer.Player1 ? EPlayer.Player2: EPlayer.Player1;
        }

        //Retorna false caso o jogador deseja encerrar a partida
        private Boolean CheckWinner()
        {
            if(Player1Cards.Count == 0 && Player2Cards.Count == 0)
                MessageBox.Show("Fim de Jogo, Não Houve Ganhador! ");
        ...
        private EPlayer type(ECategory eCategory)
        {
            ...
            return (player1 ? EPlayer.Player1 : player2 ? EPlayer.Player2 : EPlayer.Tied);           
        }
        ...
        private void PopulatePlayer(EPlayer player)
        {
            ...
            if (player == EPlayer.Player1)
            {
                ...
                picCountryPlayer1.Image = EnumsImageCountry.ImageCoutry(CarPlayer1.Country);
                lbCarNamePlayer1.Text = CarPlayer1.Name;
            ...
            else if (player == EPlayer.Player2)
            {
                ...
                picCountryPlayer2.Image = EnumsImageCountry.ImageCoutry(CarPlayer2.Country);
                lbCarNamePlayer2.Text = CarPlayer2.Name;
